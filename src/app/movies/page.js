    ...
    <div className="py-32">
        ...
        <div className="mx-auto grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
            <div className="group bg-card p-2 rounded-xl cursor-pointer hover:bg-[#1e414e] transition-all">
              ...
              <button type="button" class="invisible group-hover:visible mt-4 text-white bg-primary hover:bg-primary-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Edit</button>
              </div>              
            </div>
